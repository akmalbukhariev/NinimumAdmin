...
export function ProductsPage() {
  ...
  return <>
    ...
    <Dialog open={Boolean(edit)} onClose={() => setEdit(null)} fullWidth maxWidth="md">
      ...
      <DialogContent sx={{ pt: '12px!important' }}><Box display="grid" gridTemplateColumns={{ xs: '1fr', md: '1fr 1fr' }} gap={3}>
